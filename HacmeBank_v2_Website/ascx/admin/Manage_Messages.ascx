<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Manage_Messages.ascx.cs" Inherits="HacmeBank_v2_Website.ascx.AdminManageMessages" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
