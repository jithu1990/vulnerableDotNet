<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Web_Services.ascx.cs" Inherits="HacmeBank_v2_Website.ascx.WebServices" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
