<%@ Control Language="c#" AutoEventWireup="false" Codebehind="AdminSection.ascx.cs" Inherits="HacmeBank_v2_Website.ascx.AdminSection" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
