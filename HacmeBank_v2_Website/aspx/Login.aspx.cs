...
namespace HacmeBank_v2_Website
{
	...
	public class Login : System.Web.UI.Page
	{
		...
		protected System.Web.UI.WebControls.Label lbXmlInformation;		
...
*/			
		...
		{			
			try 
			{
				string loginResult = Global.objUserManagement.WS_Login(txtUserName.Text,txtPassword.Text);
				try
				{
				...
				if ("0" != loginResult)				
				{				
					dataClasses.userData objUserData = Global.objUserManagement.setupUserSession(loginResult , txtUserName.Text);												
