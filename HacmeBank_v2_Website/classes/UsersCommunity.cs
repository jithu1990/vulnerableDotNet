...
namespace HacmeBank_v2_Website
{
	...
	public class UsersCommunity
	{
		...
		private static WS_UsersCommunity.WS_UsersCommunity objWS_UsersCommunity = new HacmeBank_v2_Website.WS_UsersCommunity.WS_UsersCommunity(ipAddressOfWebService);
