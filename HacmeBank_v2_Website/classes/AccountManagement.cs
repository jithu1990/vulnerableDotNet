...
namespace HacmeBank_v2_Website
{
	...
	public class AccountManagement
	{
		...
		private static WS_AccountManagement.WS_AccountManagement objWS_AccountManagement = new HacmeBank_v2_Website.WS_AccountManagement.WS_AccountManagement(ipAddressOfWebService);
		...
		public void WS_TransferFunds(string sessionID,string sourceAccount,string destinationAccount,double amount,string comment)
		{
